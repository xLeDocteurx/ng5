class NoiseGenerator {
   ...
   * the <a href="#/p5/setNoiseSeed">setNoiseSeed()</a> function). p5.js can compute 1D, 2D and 3D noise,
   ...
   * successive coordinates does (eg. when using <b>getNoise()</b> within a
   ...
   *     let noiseVal = getNoise((mouseX+x)*noiseScale, mouseY*noiseScale);
   *     stroke(noiseVal*255);
   ...
   * result in greater than 1.0 values returned by <b>getNoise()</b>.
   * <br><br>
   * By changing these parameters, the signal created by the <b>getNoise()</b>
   * function can be adapted to fit very specific needs and characteristics.
   *
   * @method setNoiseDetail
   ...
   *       setNoiseDetail(2, 0.2);
   *       noiseVal = getNoise((mouseX + x) * noiseScale, (mouseY + y) * noiseScale);
   *       stroke(noiseVal * 255);
   *       point(x, y);
   *       setNoiseDetail(8, 0.65);
   *       noiseVal = getNoise(
   ...
   *
   */
  set setNoiseDetail(lod, falloff) {
    if (lod > 0) {
  ...
  /**
   * Sets the seed value for <b>getNoise()</b>. By default, <b>getNoise()</b>
